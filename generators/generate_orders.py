...
# Population-weighted city probabilities (approximate relative weights)
CITY_WEIGHTS = {
...
def generate_products(n=500):
    ...
    for _ in range(n):
        ...
        # Log-normal price distribution within range for realism
...
def generate_orders_and_items(num_orders=50000, num_items=150000):
    ...
    # Group products by category for weighted selection
    products_by_cat = {}
    ...
    for order_id in range(1, num_orders + 1):
        ...
        for _ in range(num_items_this_order):
            # Select category with weights, then pick product from that category
